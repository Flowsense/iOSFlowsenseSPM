...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "FlowsenseSDK",
            url: "https://github.com/Flowsense/iOSFlowsenseSPM/releases/download/4.1.2-beta/SDK_4.1.2-beta.zip",
            checksum: "bc05ff79ebf0cd87ff64863d3da9c927efbae078feb7a8931a7a45d053b53fbe"
        ),
