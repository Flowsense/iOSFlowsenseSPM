...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "FlowsenseSDK",
            url: "https://github.com/Flowsense/iOSFlowsenseSPM/releases/download/4.1.3-beta/SDK_4.1.3-beta.zip",
            checksum: "901b37752af7b4cd25076c322cd594ad7d96490df1f661cac6e70d4b9e7d0056"
        ),
